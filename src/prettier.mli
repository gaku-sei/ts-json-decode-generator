...
val defaultPrettierOptions : prettierOptions

val resolvePrettierConfig : string -> prettierOptions Js.Nullable.t Js.Promise.t

val prettify : string -> prettierOptions -> string
